...
// Export a function we will use to DELETE from the database
export const deleteDb = async (id) => {
  ...
  // Create a new transaction and specify the store and the data privileges
  const tx = contactDb.transaction("contacts", "readwrite");

  // Open up the desired object store
  const store = tx.objectStore("contacts");

  // Use the .delete() method to delete data in the database
